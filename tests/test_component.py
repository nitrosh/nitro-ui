...
class TestComponentBasic(unittest.TestCase):
    ...
    def test_component_default_slot(self):
        ...
        self.assertEqual(
            str(result), '<div class="card"><p>Hello</p><p>World</p></div>'
        )
    ...
    def test_component_with_props(self):
        ...
        class Card(Component):
            ...
            def template(self, title: str):
                return [H3(title, cls="card-title"), Slot()]
    ...
    def test_component_prop_with_default(self):
        ...
        class Alert(Component):
            ...
            def template(self, message: str, level: str = "info"):
                return [Span(f"[{level.upper()}]", cls="level"), Span(message)]
...
class TestComponentSlots(unittest.TestCase):
    ...
    def test_named_slot(self):
        ...
        result = Modal("My Modal", Paragraph("Body content"), footer=Button("Close"))
        rendered = str(result)
    ...
    def test_named_slot_with_list(self):
        ...
        class Modal(Component):
            ...
            def template(self):
                return [Div(Slot(), cls="body"), Div(Slot("actions"), cls="actions")]

        result = Modal(Paragraph("Content"), actions=[Button("Cancel"), Button("OK")])
        rendered = str(result)
    ...
    def test_empty_slot(self):
        ...
        class Card(Component):
            ...
            def template(self):
                return [Div(Slot(), cls="body"), Div(Slot("footer"), cls="footer")]
...
class TestComponentEdgeCases(unittest.TestCase):
    ...
    def test_no_slot_appends_children(self):
        ...
        self.assertEqual(str(result), "<div><span>Hi</span><p>Extra</p></div>")
    ...
    def test_none_in_template_filtered(self):
        ...
        class Conditional(Component):
            ...
            def template(self, show_icon: bool = False):
                return [Span("*") if show_icon else None, Slot()]
    ...
    def test_deeply_nested_slots(self):
        ...
        class Complex(Component):
            ...
            def template(self):
                return [Div(Div(Div(Slot(), cls="inner"), cls="middle"), cls="outer")]

        result = Complex(Paragraph("Deep"))
        self.assertIn('<div class="inner"><p>Deep</p></div>', str(result))
    ...
    def test_empty_children(self):
        ...
        result = Card("Title")
        self.assertEqual(str(result), '<div class="card"><h3>Title</h3></div>')
