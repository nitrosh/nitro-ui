...
Anchor = simple_tag_class("a")
Href = Anchor  # Backward-compatible alias
...
Bdi = simple_tag_class("bdi")
Bdo = simple_tag_class("bdo")
Ruby = simple_tag_class("ruby")
Rt = simple_tag_class("rt")
Rp = simple_tag_class("rp")
Data = simple_tag_class("data")
